...
This project is equipped with the following professional skills and agents:
...
## Integrated Tools (MCP)
- **Agent Memory**: Long-term memory and session recall.
- **Stitch**: Design system automation.

Refer to the linked skill files in `opencode.json` for detailed instructions on how to use these capabilities.
